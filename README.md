...
## Perspective API Sunsetting
Perspective API is sunsetting and will not be in service after 2026. New access requests are no longer being accepted as of February 28th, 2026. This project remains as an example of my work, but due to its lack of real usage and because Perspective is being shut down, it will no longer be maintained. For more information on Perspective's sunset, visit [their website](https://perspectiveapi.com).
