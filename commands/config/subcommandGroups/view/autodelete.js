...
module.exports = async (interaction) => {
	...
	if (guildConfig && guildConfig.auto_delete) {
		interaction.editReply('`' + guildConfig.auto_delete + '`');
	} else {
		interaction.editReply('This server does not have a value set for autodelete. Without this value set, it will default to `false`');
	}
};